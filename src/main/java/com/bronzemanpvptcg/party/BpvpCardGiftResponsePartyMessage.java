...
/**
 * Recipient answers a {@link BpvpCardGiftPartyMessage}: accepted after adding the card, or rejected when multiplier /
...
public class BpvpCardGiftResponsePartyMessage extends PartyMemberMessage
{
